<template>
  <div>
    ...
    <van-button type="default" size="large">一键登录</van-button>
    <div class="quick_button">
      <span style="position: absolute;left: 20px">短信验证码登录</span>
      <span style="position: absolute;right: 20px">手机快速注册</span>
    </div>
    <div style="border-top: 1px solid rgba(0,0,0,.1);margin-top: 100px;" >
      <h4 class="other_button">其他登录方式</h4>
      <p>
        <a href="#" class="icon_qq other_login_txt">QQ</a>
        <a href="#" class="icon_wechat other_login_txt">微信</a>
      </p>
    </div>
    <div class="policy_tip">
      <span>未注册的手机号验证后将自动创建京东账号，登录即代表您已同意</span>
      <a href="https://in.m.jd.com/help/app/private_policy.html" style="color: #1471FB">京东隐私政策</a>
    </div>
  </div>
</template>
